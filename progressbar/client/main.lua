        ...
        if not isDoingAction then
            ...
            Citizen.CreateThread(function ()
                ...
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, Keys["ENTER"]) and Action.canCancel then
            ...
            TriggerEvent("notification","Zaten birsey üzerinde calisiyorsun!")
        end
    else
        TriggerEvent("notification","Islem gerceklestirilemez!")
    end
end
